...
export const components: ComponentDefinition[] = [
  ...
  {
    name: "fan",
    path: path.join(__dirname, "../icons/fan.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
    name: "phone-off",
    path: path.join(__dirname, "../icons/phone-off.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
  ...
  {
    name: "router",
    path: path.join(__dirname, "../icons/router.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
    name: "satellite-dish",
    path: path.join(__dirname, "../icons/satellite-dish.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
  ...
  {
    name: "wifi-cog",
    path: path.join(__dirname, "../icons/wifi-cog.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
    name: "wifi-pen",
    path: path.join(__dirname, "../icons/wifi-pen.tsx"),
    registryDependencies: [],
    dependencies: ["motion"],
  },
  {
